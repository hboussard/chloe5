...
public class TabRookDiscreteClusteringAnalysis extends TabChessClusteringAnalysis {
	
	public TabRookDiscreteClusteringAnalysis(float[] inDatas, int width, int height, int[] interest, int noDataValue){	
