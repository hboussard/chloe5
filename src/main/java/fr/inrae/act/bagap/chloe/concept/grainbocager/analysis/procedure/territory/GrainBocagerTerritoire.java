...
public class GrainBocagerTerritoire {
	...
	*/
	private String outputPath; // dossier de g�n�ration des sorties
	...
	public void run(){
		...
		// r�cup�ration de l'entete du bocage
		...
		Envelope envelope = ShapeFileTool.getEnvelope(territoire, bufferArea);
	...
	private float[] getElementsBoises(String bocage, EnteteRaster entete) {
		...
		//System.out.println("r�cup�ration des �l�ments bois�s");
