...
public class Script {
	...
	private static void scriptMultipleSelected(){
		...
		// analyse avec une seule taille de fen�tre
		...
		// les points demand�s sont export�s 
		// mais :
		// pb : avec des identifiants non demand�s
		...
		// les points d�cal�s demand�s sont export�s 
		// mais,
		// pb : avec des identifiants non demand�s
		...
		// les points demand�s sont export�s avec les identifiants demand�s
		...
		// les points d�cal�s demand�s sont export�s avec les identifiants demand�s
