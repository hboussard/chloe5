...
public class EmpriseBocageKernel3 extends SlidingLandscapeMetricKernel {
	...
	public EmpriseBocageKernel3(int windowSize, int displacement, short[] shape, float[] coeff, int noDataValue, int[] unfilters) {
		super(windowSize, displacement, shape, coeff, noDataValue, unfilters);
	}
	
	public void setImage2(float[] image2){
		this.image2 = image2;
	}
