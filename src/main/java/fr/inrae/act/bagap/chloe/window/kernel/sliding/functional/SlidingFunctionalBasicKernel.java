...
public class SlidingFunctionalBasicKernel extends SlidingFunctionalKernel {
	
	public SlidingFunctionalBasicKernel(int windowSize, int displacement, int noDataValue, int[] unfilters, double cellSize, DistanceFunction function, double radius){		
