...
public class PatchCounting extends Counting implements PatchCountingInterface {
	 ...
	 * 5 : surface totale
	 * 6 : surface max
	 * � partir de 7 jusqu'au nombre de valeurs + 7 : les nombres de patch par classe
	 * � partir de nombre de valeurs + 7 jusqu'� 2*nombre de valeurs + 7 : les surfaces totales par classe
	 * � partir de 2*nombre de valeurs + 7 jusqu'� 3*nombre de valeurs + 7 : les maximum de surfaces par classe
	 */
 	@Override
