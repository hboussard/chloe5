...
public class ProportionKernel extends SlidingLandscapeMetricKernel {

	private float minHauteur = 1; // hauteur en metres minimum de l'element boise pour etre pris en compte
	
	public ProportionKernel(int windowSize, int displacement, short[] shape, float[] coeff, int noDataValue, int[] unfilters) {
