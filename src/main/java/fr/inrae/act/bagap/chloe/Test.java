...
public class Test {
	...
	public static void main(String[] args) {
		...
		*/
		...
		Coverage cov = CoverageManager.getCoverage("I:/2014ren.asc");
		EnteteRaster entete = cov.getEntete();
		cov.dispose();
		
		Coverage covParcellaire = ShapeFile2CoverageConverter.getCoverage("I:/prop2019ren.shp", "Code_1", 5, entete.noDataValue(), entete.minx(), entete.maxx(), entete.miny(), entete.maxy(), entete.noDataValue());
		float[] dataParcellaire = covParcellaire.getDatas();
		covParcellaire.dispose();	
		
		CoverageManager.write("I:/2019ren_bis.asc", dataParcellaire, entete);
