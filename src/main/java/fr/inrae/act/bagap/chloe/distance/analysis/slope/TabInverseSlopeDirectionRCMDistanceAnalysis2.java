...
public class TabInverseSlopeDirectionRCMDistanceAnalysis2 extends Analysis {
	...
	public TabInverseSlopeDirectionRCMDistanceAnalysis2(float[] outDatas, float[] inDatas, float[] frictionDatas, float[] slopeDirectionDatas, int width, int height, float cellSize, int noDataValue, int[] codes) {
		this(outDatas, inDatas, frictionDatas, slopeDirectionDatas, width, height, cellSize, noDataValue, codes, noDataValue);
	}
	
	public TabInverseSlopeDirectionRCMDistanceAnalysis2(float[] outDatas, float[] inDatas, float[] frictionDatas, float[] slopeDirectionDatas, int width, int height, float cellSize, int noDataValue, int[] codes, int threshold) {
