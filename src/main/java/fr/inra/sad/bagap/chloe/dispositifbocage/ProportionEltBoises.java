...
public class ProportionEltBoises {
		...
		try {
			...
			*/
			...
			for(short v : values){
				...
				metric.addObserver(new GeoTiffOutput("F:/dispositif_bocage/dpt22/grain/elt_boises/distance/test2/pNV_"+v+".tif", outWidth, outHeight, outMinX, outMaxX, outMinY, outMaxY, outCellSize));
