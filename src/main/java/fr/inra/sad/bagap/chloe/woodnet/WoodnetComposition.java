package fr.inra.sad.bagap.chloe.woodnet;
...
public class WoodnetComposition {
	...
	public static void main(final String[] args) {
		try {
			...
			File file = new File("C:/Hugues/agents/nicolas/os2018.asc");
			...
			*/
			...
			for(short v : values){
				...
				metric.addObserver(new AsciiGridOutput("C:/Hugues/agents/nicolas/os/image_count_"+v+".asc", outWidth, outHeight, outMinX, outMinY, outCellSize, (short) Raster.getNoDataValue()));
				
			}
			
			//CsvOutput csvOut = new CsvOutput("C:/Hugues/agents/nicolas/.csv", outMinX, outMaxX, outMinY, outMaxY, outWidth, outHeight, outCellSize, (short) Raster.getNoDataValue(), vc.metrics());
