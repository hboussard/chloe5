...
public class GaussianWeigthedCountKernel extends Kernel {
	...
	public GaussianWeigthedCountKernel(short[] values, int windowSize, int width, int height, int dep, float[] imageIn, float[][] imageOut, int noDataValue){
		this(values, windowSize, width, height, dep, imageIn, imageOut, noDataValue, 0);
	}
		
	
	public GaussianWeigthedCountKernel(short[] values, int windowSize, int width, int height, int dep, float[] imageIn, float[][] imageOut, int noDataValue, int enveloppeInterne){
