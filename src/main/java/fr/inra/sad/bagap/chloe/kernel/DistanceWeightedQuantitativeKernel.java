...
public class DistanceWeightedQuantitativeKernel extends Kernel {
	...
	public DistanceWeightedQuantitativeKernel(int windowSize, short[] shape, float[] coeff, int width, int height, int dep, float[] imageIn, double[][] imageOut, float noDataValue, int enveloppeInterne){
