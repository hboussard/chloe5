...
public class SquareCountKernel extends Kernel {
	...
	public SquareCountKernel(int nValues, int windowSize, int width, int height, int dep, float[] imageIn, float[][] imageOut){
		this(nValues, windowSize, width, height, dep, imageIn, imageOut, 0);
	}
		
	
	public SquareCountKernel(int nValues, int windowSize, int width, int height, int dep, float[] imageIn, float[][] imageOut, int enveloppeInterne){
	...
	//	System.out.println("x="+x_out+" , y="+y_out+" , "+imageOut[ind][1]+" , "+imageOut[ind][2]);
