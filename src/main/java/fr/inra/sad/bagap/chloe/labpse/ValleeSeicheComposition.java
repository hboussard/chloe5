...
public class ValleeSeicheComposition {
	...
	public static void main(final String[] args) {
		try {
			...
			*/
			...
			CsvOutput csvOut = new CsvOutput("F:/Requete_SIG_LabPSE/vallee_de_la_seiche/data/ecopaysage/vallee_seiche_comp_gaussian_500m.csv", outMinX, outMaxX, outMinY, outMaxY, outWidth, outHeight, outCellSize, (short) Raster.getNoDataValue(), vc.metrics());
