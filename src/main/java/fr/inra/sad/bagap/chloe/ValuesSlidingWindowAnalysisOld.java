...
public class ValuesSlidingWindowAnalysisOld {
	...
	public static void main(final String[] args) {
		try {
			...
			//File file = new File("C:/Users/hboussard/modelisation/chloe/chloe5/data/bretagne.tif");
			...
			for(short s : inDatas){
				if(s!=noDataValue && s!=0 && !inValues.contains(s)){
					inValues.add(s);
				}
			}
			...
			*/
			...
			metric.addObserver(new TextImageOutput("C:/Users/hboussard/modelisation/chloe/chloe5/data/output/image_shdi.txt", (short) (((width-1)/dep)+1)));
			vc.addMetric(metric);
			
			for(short v : values){
				metric = new CountValueMetric(v);
				metric.addObserver(new TextImageOutput("C:/Users/hboussard/modelisation/chloe/chloe5/data/output/image_count_"+v+".txt", (short) (((width-1)/dep)+1)));
				vc.addMetric(metric);
			}
