...
public class DrealConfiguration {
	...
	public static void main(final String[] args) {
		try {
			...
			DistanceWeightedCountCoupleKernel cv = new DistanceWeightedCountCoupleKernel(couples, windowSize, shape, coeffs, roiWidth, roiHeight, dep, inDatas, outDatas, (float) Raster.getNoDataValue(), 600);
			//ThresholdCountCoupleKernel cv = new ThresholdCountCoupleKernel(couples, windowSize, shape, roiWidth, roiHeight, dep, inDatas, outDatas, Raster.getNoDataValue(), 600);
			...
			CsvOutput csvOut = new CsvOutput("C:/Users/hboussard/modelisation/chloe/chloe5/data/output/dreal_conf_weighted_3km.csv", outMinX, outMaxX, outMinY, outMaxY, outWidth, outHeight, outCellSize, (short) Raster.getNoDataValue(), cc.metrics());
