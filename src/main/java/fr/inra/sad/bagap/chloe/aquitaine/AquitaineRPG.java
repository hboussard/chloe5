package fr.inra.sad.bagap.chloe.aquitaine;
...
public class AquitaineRPG {
	...
	public static void main(final String[] args) {
		try {
			...
			File file = new File("F:/aquitaine/raster/rpg/rpg_dordogne_2017_clean.asc");
			...
			*/
			...
			CsvOutput csvOut = new CsvOutput("F:/aquitaine/raster/composition/rpg_dordogne_2017_comp_gaussian_3km.csv", outMinX, outMaxX, outMinY, outMaxY, outWidth, outHeight, outCellSize, (short) Raster.getNoDataValue(), vc.metrics());
