...
public class Test {
	...
	public static void main(final String[] args) {
		try {
			...
			File file = new File("F:/dispositif_bocage/haie_bosquet_dpt22/combine.asc");
			...
			*/
			...
			CsvOutput csvOut = new CsvOutput("F:/dispositif_bocage/haie_bosquet_dpt22/test.csv", outMinX, outMaxX, outMinY, outMaxY, outWidth, outHeight, outCellSize, (short) Raster.getNoDataValue(), vc.metrics());
