...
public class DrealGeol {

	public static void main(final String[] args) {
		scriptEcopaysage();
	}
	
	private static void scriptEcopaysage() {
		try {
			...
			File file = new File("C:/Users/hboussard/modelisation/ecopaysage/data/geol_leguer_5m/geol_leguer_5m.tif");
			...
			DistanceWeigthedCountValueKernel cv = new DistanceWeigthedCountValueKernel(values, windowSize, shape, coeffs, roiWidth, roiHeight, dep, inDatas, outDatas, Raster.getNoDataValue(), 600);
			//ThresholdCountValueKernel cv = new ThresholdCountValueKernel(values, windowSize, shape, roiWidth, roiHeight, dep, inDatas, outDatas, Raster.getNoDataValue(), 600);
			...
			CsvOutput csvOut = new CsvOutput("C:/Users/hboussard/modelisation/chloe/chloe5/data/output/dreal_geol_weighted_3km.csv", outMinX, outMaxX, outMinY, outMaxY, outWidth, outHeight, outCellSize, (short) Raster.getNoDataValue(), vc.metrics());
